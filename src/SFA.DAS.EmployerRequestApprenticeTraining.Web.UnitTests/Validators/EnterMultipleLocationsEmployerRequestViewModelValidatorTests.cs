...
namespace SFA.DAS.EmployerRequestApprenticeTraining.Web.UnitTests.Validators
{
    ...
    public class EnterMultipleLocationsEmployerRequestViewModelValidatorTests
    {
        ...
        [Test]
        public void Should_Have_Error_When_SelectedSubRegions_Is_Null()
        {
            // Arrange
            ...
            result.ShouldHaveValidationErrorFor(x => x.SelectedSubRegions)
                .WithErrorMessage("Select a location");
        }

        [Test]
        public void Should_Have_Error_When_SelectedSubRegions_Is_Empty()
        {
            // Arrange
            var model = new EnterMultipleLocationsEmployerRequestViewModel
            {
        ...
        [Test]
        public void Should_Not_Have_Error_When_SelectedSubRegions_Is_Valid()
        {
            // Arrange
            var model = new EnterMultipleLocationsEmployerRequestViewModel
            {
            ...
            // Act & Assert
            var result = _validator.TestValidate(model);
            result.ShouldNotHaveValidationErrorFor(x => x.SelectedSubRegions);
        }
    }
}
